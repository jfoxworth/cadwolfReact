            ...
            <Grid item xs={12} lg={5}>
              <div className='flex flex-col items-start gap-6'>
                ...
                <Typography color='white' className='lg:max-is-[390px] opacity-[0.78]'>
                  The most advanced engineering platform in existence. Keep up to date with new features by following us
                  on social media.
                </Typography>
      ...
      <div className='bg-[#211B2C]'>
        ...
        >
          <Typography className='text-white opacity-[0.92]' variant='body2'>
            <span>{`© ${new Date().getFullYear()} CADWOLF`}</span>
          </Typography>
          <div className='flex gap-1.5 items-center opacity-[0.78]'>
            <IconButton component={Link} size='small' href='https://github.com/cadwolfReact' target='_blank'>
              <i className='ri-github-fill text-white text-lg' />
            </IconButton>
            <IconButton component={Link} size='small' href='https://www.facebook.com/cadwolf/' target='_blank'>
              <i className='ri-facebook-fill text-white text-lg' />
            </IconButton>
            <IconButton component={Link} size='small' href='https://twitter.com/cadwolfplatform' target='_blank'>
              <i className='ri-twitter-fill text-white text-lg' />
            </IconButton>
            <IconButton component={Link} size='small' href='https://www.linkedin.com/company/cadwolf' target='_blank'>
