...
function emptySeries(): PlotSeries {
  return { x: "", y: "", label: "", mode: "markers", color: "#2563eb", markerSize: 8 };
}
    ...
    <div className="rounded border border-gray-200 bg-gray-50 p-3 flex flex-col gap-2">
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <label className="flex flex-col gap-0.5">
          ...
          <input type="number" min={1} max={30} step={1} value={series.markerSize ?? 8}
...
export default function ScatterEdit({ draft, varNames, onChange }: Props) {
